...
# ========== 超参数默认值 ==========
K_AUGMENT = 3                   # 指令增强调用次数 (每次生成 ~50 条)
...
QUALITY_SCORE_THRESHOLD = 8     # 质量评分阈值 (0-10)
QUERIES_PER_INSTRUCTION = 16    # 每条指令配对的查询数
DPO_POSITIVE_THRESHOLD = 0.7    # DPO 正样本阈值
EXEC_TIMEOUT = 5                # 验证函数执行超时 (秒)
LLM_MAX_WORKERS = 8             # LLM 并发调用数
